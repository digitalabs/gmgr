...
class pagination {
        ...
        if (($this->pages) > 1) {
            ...
            if ($this->page != 1) {
                if ($this->_showFirstAndLast) {
                    $plinks[] = '<li> <a href="?page=1' . $queryUrl . '#GermplasmList">&laquo;&laquo; First </a> </li>';
                }
                $plinks[] = '<li> <a href="?page=' . ($this->page - 1) . $queryUrl . '#GermplasmList">&laquo; Prev</a> </li>';
            }
            ...
            for ($j = 1; $j < ($this->pages + 1); $j++) {
                if ($this->page == $j) {
                    ...
                    $links[] = '<li> <a href="?page=' . $j . $queryUrl . '#GermplasmList">' . $j . '</a> </li>'; // add the link to the array
                }
            }

            // Assign the 'next page' if we are not on the last page
            if ($this->page < $this->pages) {
                $slinks[] = ' <li><a href="?page=' . ($this->page + 1) . $queryUrl . '#GermplasmList"> Next &raquo; </a> </li>';
                if ($this->_showFirstAndLast) {
                    $slinks[] = ' <li><a href="?page=' . ($this->pages) . $queryUrl . '#GermplasmList"> Last &raquo;&raquo; </a> </li>';
                }
            }
    ...
    public function getLinks2($params = array()) {
        // Initiate the links array
        $plinks = array();
        $links = array();
        $slinks = array();
