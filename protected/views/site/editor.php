...
-->
	<!-- Scroll bar present but disabled -->
			<table style="vertical-align:center;">
				<tr>
					<td width="50%">
						<div id="graphDiv" style="width: 650px; height: 495px;overflow-x:hidden;overflow-y:hidden;max-height:78%;vertical-align:center;background-color:#F8F8F8;">
							
						</div>
					</td>
					<td width="50%" style="vertical-align:center;">
						<div id="attDiv" style="vertical-align:center;text-align:top;position:absolute;top:0;"><br>
