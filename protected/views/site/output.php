...
<body onload="storeLocal()">
    ...
    echo CHtml::hiddenField('count', count($list));
    ...
    $(document).ready(function() {
        ...
        if (non_stardardized != 0) {
            ...
            $.pnotify(
                    {
                        title: "<br>",
                        text: "There are still <b>" + $('#non_standard_size').val() + "</b> / <b>" + $('#count').val() + "</b> non-standardized names. Click the Germplasm name to correct before you are allowed to assign GID.",
                        type: "warning",
                        hide: false,
                    }
            );
