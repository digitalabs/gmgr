...
class SiteController extends Controller {
    ...
    public function actionCreatedGID() {
		...
		//**********Get the selected ids for the checked checkboxe(s)*********
		...
		//****End for getting the selected ids for the checked checkboxe(s)*********
		/*
        Yii::import('application.modules.file_toArray');
        $file_toArray = new file_toArray();
        ...
        $final = $file_toArray->getPedigreeLine();
         ...
         if(Yii::app()->request->isAjaxRequest) $this->renderPartial('createdGID', array('GdataProvider'=>$GdataProvider,'checked'=>$checked),false,true);
         else $this->render('createdGID', array('GdataProvider'=>$GdataProvider,'selectedId'=>$checked));
